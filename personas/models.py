...
class TipoResidencia(models.Model):
    id = models.AutoField(primary_key=True, editable=False)
    nombre = models.CharField(max_length=765)
    temporal = models.BooleanField(null=True, blank=True)
    notas = models.TextField(blank=True)
    def __str__(self):
        return self.nombre
...
class Residencia(models.Model):
    ...
    lugar_nacimiento = models.BooleanField(null=True, blank=True)
    lugar_defuncion = models.BooleanField(null=True, blank=True)
    notas = models.TextField(blank=True)
    def __str__(self):
